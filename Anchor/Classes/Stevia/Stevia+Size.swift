...
@available(iOS, deprecated: 4.1.0, renamed:"equal(sizes:)")
@discardableResult
...
@available(iOS, deprecated: 4.1.0, renamed:"equal(widths:)")
@discardableResult
...
@available(iOS, deprecated: 4.1.0, renamed:"equal(heights:)")
@discardableResult
